package com.niklasweber.montecarlo;
 ...
 * d dimensions by the integration of 1_{\{x_1^2+x_2^+...+x_d^2 <= 1\}.
 * Note that this class extends MonteCarloEvaluationsWithExactResultAbstract,
 *  since it's possible to get statistics on the error by calling the inherited methods
...
public class MonteCarloPiFromHypersphere extends MonteCarloEvaluationsWithExactResultAbstract {
	...
	private final int dimension;// dimension of the unit hyperpshere
