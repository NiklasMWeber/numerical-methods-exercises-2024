...
import com.niklasweber.usefulmethodsmatricesandvectors.UsefulMethodsMatricesAndVectors;

/**
 * This is an abstract class inheriting from MonteCarloEvaluationsAbstract, hence
...
implements MonteCarloEvaluationsWithExactResultInterface {
	...
	private final double exactResult;// hosts the exact value of the quantity we approximate
